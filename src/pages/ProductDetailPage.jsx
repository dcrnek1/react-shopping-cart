...
export default function ProductDetailPage() {
  ...
  return (
    <section className="bg-white antialiased max-w-7xl mx-auto w-full">
      {/* Breadcrumbs */}
      <nav className="flex py-5 sm:py-5 sm:pb-9 px-2 sm:px-0" aria-label="Breadcrumb">
        <ol className="inline-flex items-center space-x-1 sm:space-x-2 rtl:space-x-reverse">
          <Link to="/products">
            <div className="flex items-center">
              <a href="#" className="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 sm:ms-2 dark:text-gray-400 dark:hover:text-white">Products</a>
            </div>
          </Link>
            <div className="flex items-center">
              ...
              <span className="ms-1 text-sm font-medium text-gray-500 sm:ms-2 dark:text-gray-400 line-clamp-1">{product && product.title}</span>
            </div>
        </ol>
      </nav>
      {product && (
              ...
              <div className="mt-4 sm:items-center sm:gap-4 sm:flex">
                ...
                <div className="flex items-center gap-2 mt-2 sm:mt-0">
                  <div className="flex items-center gap-1">
                    <svg
                      className={`w-4 h-4 ${product && product.rating && product.rating.rate < 0.5 ? "text-gray-200" : "text-yellow-300"}`}
                      aria-hidden="true"
                    ...
                    <svg
                      className={`w-4 h-4 ${product && product.rating && product.rating.rate < 1.5 ? "text-gray-200" : "text-yellow-300"}`}
                      aria-hidden="true"
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                      height="24"
                    ...
                    <svg
                      className={`w-4 h-4 ${product && product.rating && product.rating.rate < 2.5 ? "text-gray-200" : "text-yellow-300"}`}
                      aria-hidden="true"
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                      height="24"
                    ...
                    <svg
                      className={`w-4 h-4 ${product && product.rating && product.rating.rate < 3.5 ? "text-gray-200" : "text-yellow-300"}`}
                      aria-hidden="true"
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                      height="24"
                    ...
                    <svg
                      className={`w-4 h-4 ${product && product.rating && product.rating.rate < 4.5 ? "text-gray-200" : "text-yellow-300"}`}
                      aria-hidden="true"
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                      height="24"
