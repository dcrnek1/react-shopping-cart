            ...
            <div className="mt-6 sm:mt-8 lg:mt-0 lg:col-span-7">
              ...
              <div className="mt-5 sm:gap-4 sm:items-center flex justify-end sm:justify-start sm:mt-8">
                <button
                  ...
                  className="text-white mt-0 sm:mt-0 bg-primary hover:bg-primary/70 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 focus:outline-none flex items-center gap-3 justify-center"
                >
